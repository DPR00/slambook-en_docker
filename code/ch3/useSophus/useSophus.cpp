...
int main() {
    // Rotation matrix with 90 degrewes along Z axis
    Matrix3d R = AngleAxisd(M_PI / 2, Vector3d(0, 0, 1)).toRotationMatrix();
    // or quaternion
    Quaterniond q(R);
    Sophus::SO3d SO3_R(R);  // Can be constructed from rotation matrix
    Sophus::SO3d SO3_q(q);  // or from quaternion
    ...
    // Use logaritmic map to get the Lie algebra
